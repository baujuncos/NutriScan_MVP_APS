      ...
      {selectedAlimento && (
        ...
        >
          ...
          <div className="flex gap-2">
            ...
            <select
              name="tipo_item"
              className="rounded-xl border border-gray-200 bg-white px-2 py-2.5 text-sm text-gray-700 focus:outline-none focus:ring-2 transition-all"
              style={{ ['--tw-ring-color' as string]: `${accentColor}40` }}
            >
              <option value="solido">Sólido (g)</option>
              <option value="liquido">Líquido (ml)</option>
              <option value="en polvo">En polvo (g)</option>
            </select>
          </div>
                ...
                <div className="flex items-start justify-between gap-3">
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-gray-400 mt-0.5">
                      {toNum(item.cantidad).toFixed(0)}
                      {item.tipo_item === 'liquido' ? ' ml' : ' g'} · {item.tipo_item}
                    </p>
